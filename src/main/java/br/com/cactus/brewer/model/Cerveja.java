package br.com.cactus.brewer.model;
...
import br.com.cactus.brewer.validation.SKU;
...
public class Cerveja {
	...
	@NotNull(message = "Campo comissão obrigatório")
	@DecimalMax(value = "100.0", message = "A comissão deve ser igual ou menor que 100")
	private BigDecimal comissao;

	@NotNull(message = "Valor quantidade em estoque obrgatório")
